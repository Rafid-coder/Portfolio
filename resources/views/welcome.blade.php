...
<!-- Content
  ...
  <div id="content" role="main"> 
      ...
      <div class="container my-auto py-5 py-lg-0">
        <div class="row py-4">
          <div class="col-lg-7 text-center text-lg-start align-self-center order-1 order-lg-0">
            ...
            <h2 class="text-21 fw-600 text-uppercase mb-0 ms-n1"><span class="typed">Callum</span><span class="typed-cursor">|</span></h2>
            <p class="text-5">based in Los Angeles, USA.</p>
            <a href="https://harnishdesign.net/demo/html/callum/index-standard-menu.html#portfolio" class="btn btn-dark rounded-0 smooth-scroll mt-3">View My Works</a><a href="https://harnishdesign.net/demo/html/callum/index-standard-menu.html#contact" class="btn btn-link text-dark smooth-scroll mt-3">Contact Me<span class="text-4 ms-2"><i class="far fa-arrow-alt-circle-down"></i></span></a> </div>
          <div class="col-lg-5 text-center align-self-center mb-4 mb-lg-0 order-0 order-lg-1">
            <div class="bg-light rounded-pill d-inline-block p-3 shadow-lg wow zoomIn" style="visibility: visible;"> <img class="img-fluid rounded-pill d-block" src="{{asset('assets/front/image/web-developer.jpg')}}" title="I&#39;m Callum" alt=""></div>
          </div>
        </div>
      </div>
      <a href="https://harnishdesign.net/demo/html/callum/index-standard-menu.html#about" class="scroll-down-arrow text-dark smooth-scroll"><span class="animated"><i class="fas fa-arrow-down"></i></span></a> </section>
    <!-- Intro end --> 
    ...
    <section id="about" class="section">
      <div class="container"> 
        <!-- Heading -->
        <p class="text-center mb-2 wow fadeInUp" style="visibility: hidden; animation-name: none;"><span class="bg-primary text-dark px-2">About Me</span></p>
        <h2 class="text-10 fw-600 text-center mb-5 wow fadeInUp" style="visibility: hidden; animation-name: none;">Know Me More</h2>
        <!-- Heading end-->
        
        <div class="row">
          <div class="col-lg-8 text-center text-lg-start wow fadeInUp" style="visibility: hidden; animation-name: none;">
          ...
          <div class="col-lg-4 mt-4 mt-lg-0 wow fadeInUp" data-wow-delay="0.2s" style="visibility: hidden; animation-delay: 0.2s; animation-name: none;">
            <div class="featured-box style-4">
              <div class="featured-box-icon text-25 fw-500 bg-primary rounded-circle"><span class="wow heartBeat" data-wow-delay="1.3s" style="visibility: hidden; animation-delay: 1.3s; animation-name: none;">22</span></div>
              <h3 class="text-7 wow rubberBand" data-wow-delay="2s" style="visibility: hidden; animation-delay: 2s; animation-name: none;">Years of <span class="fw-700">Experiance</span></h3>
            </div>
          </div>
        </div>
        <div class="row gy-3 mt-4">
          <div class="col-6 col-lg-3 wow fadeInUp" style="visibility: hidden; animation-name: none;">
            <p class="text-muted fw-500 mb-0">Name:</p>
            <p class="text-4 text-dark fw-600 mb-0">Callum Smith</p>
          </div>
          <div class="col-6 col-lg-3 wow fadeInUp" data-wow-delay="0.2s" style="visibility: hidden; animation-delay: 0.2s; animation-name: none;">
            <p class="text-muted fw-500 mb-0">Email:</p>
            <p class="text-4 fw-600 mb-0"><a class="link-dark" href="#">chat@callum.com</a></p>
          </div>
          <div class="col-6 col-lg-3 wow fadeInUp" data-wow-delay="0.3s" style="visibility: hidden; animation-delay: 0.3s; animation-name: none;">
            <p class="text-muted fw-500 mb-0">Date of birth:</p>
            <p class="text-4 text-dark fw-600 mb-0">11 November, 1987</p>
          </div>
          <div class="col-6 col-lg-3 wow fadeInUp" data-wow-delay="0.4s" style="visibility: hidden; animation-delay: 0.4s; animation-name: none;">
    ...
    <section id="services" class="section bg-light">
      <div class="container"> 
        <!-- Heading -->
        <p class=" text-center mb-2 wow fadeInUp" style="visibility: hidden; animation-name: none;"><span class="bg-primary text-dark px-2">What I Do?</span></p>
        <h2 class="text-10 fw-600 text-center mb-5 wow fadeInUp" style="visibility: hidden; animation-name: none;">How I can help your next project</h2>
        <!-- Heading end-->
        
        <div class="row gy-5 mt-5">
          <div class="col-sm-6 col-lg-4 wow fadeInUp" style="visibility: hidden; animation-name: none;">
    ...
    <section id="resume" class="section">
      <div class="container"> 
        <!-- Heading -->
        <p class=" text-center mb-2 wow fadeInUp" style="visibility: hidden; animation-name: none;"><span class="bg-primary text-dark px-2">Resume</span></p>
        <h2 class="text-10 fw-600 text-center mb-5 wow fadeInUp" style="visibility: hidden; animation-name: none;">A summary of My Resume</h2>
        <!-- Heading end-->
        ...
        <div class="row g-5 mt-5"> 
          ...
          <!-- My Experience -->
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.2s" style="visibility: hidden; animation-delay: 0.2s; animation-name: none;">
        ...
        <!-- My Skills -->
        <h2 class="text-7 fw-600 mb-4 pb-2 mt-5 wow fadeInUp" style="visibility: hidden; animation-name: none;">My Skills</h2>
        <div class="row gx-5">
          ...
          <div class="col-md-6 wow fadeInUp" data-wow-delay="0.2s" style="visibility: hidden; animation-delay: 0.2s; animation-name: none;">
        ...
        <p class="text-center mt-5 wow fadeInUp" style="visibility: hidden; animation-name: none;"><a href="./Callum - Personal Portfolio HTML Template_files/index-standard-menu.html" class="btn btn-outline-dark shadow-none rounded-0">Download CV</a></p>
      </div>
    </section>
    <!-- Resume end --> 
    ...
    <section id="portfolio" class="section bg-light">
      <div class="container"> 
        <!-- Heading -->
        <p class=" text-center mb-2 wow fadeInUp" style="visibility: hidden; animation-name: none;"><span class="bg-primary text-dark px-2">Portfolio</span></p>
        <h2 class="text-10 fw-600 text-center mb-5 wow fadeInUp" style="visibility: hidden; animation-name: none;">Some of my most recent projects</h2>
        <!-- Heading end--> 
        
        <!-- Filter Menu -->
        <ul class="portfolio-menu nav nav-tabs fw-600 justify-content-start justify-content-md-center border-bottom-0 mb-4 wow fadeInUp" style="visibility: hidden; animation-name: none;">
        ...
        <div class="portfolio wow fadeInUp" style="visibility: hidden; animation-name: none;">
          <div class="row g-4 mt-3 portfolio-filter" style="position: relative; height: 810.812px;">
            <div class="col-sm-6 col-lg-4 detailed" style="position: absolute; left: 0px; top: 0px;">
              <div class="portfolio-box">
                <div class="portfolio-img"> <img class="img-fluid d-block" src="{{asset('assets/front/image/project-1.jpg')}}" alt="">
            ...
            <div class="col-sm-6 col-lg-4 mockups" data-wow-delay="0.2s" style="position: absolute; left: 379.984px; top: 0px;">
              <div class="portfolio-box">
                <div class="portfolio-img"> <img class="img-fluid d-block" src="{{asset('assets/front/image/project-2.jpg')}}" alt="">
                  <div class="portfolio-overlay"> <a class="popup-img stretched-link" href="{{asset('assets/front/image/project-2.jpg')}}"></a>
                    <div class="portfolio-overlay-details">
            ...
            <div class="col-sm-6 col-lg-4 youtube" data-wow-delay="0.3s" style="position: absolute; left: 759.968px; top: 0px;">
              <div class="portfolio-box">
                <div class="portfolio-img"> <img class="img-fluid d-block" src="{{asset('assets/front/image/project-3.jpg')}}" alt="">
                  <div class="portfolio-overlay"> <a class="popup-youtube stretched-link" href="#"></a>
                    <div class="portfolio-overlay-details">
            ...
            <div class="col-sm-6 col-lg-4 vimeo" style="position: absolute; left: 0px; top: 405.406px;">
              <div class="portfolio-box">
                <div class="portfolio-img"> <img class="img-fluid d-block" src="{{asset('assets/front/image/project-4.jpg')}}" alt="">
                  <div class="portfolio-overlay"> <a class="popup-vimeo stretched-link" href="#"></a>
                    <div class="portfolio-overlay-details">
                      <p class="text-primary text-8"><i class="fas fa-video"></i></p>
            ...
            <div class="col-sm-6 col-lg-4 detailed" data-wow-delay="0.2s" style="position: absolute; left: 379.984px; top: 405.406px;">
              <div class="portfolio-box">
                <div class="portfolio-img"> <img class="img-fluid d-block" src="{{asset('assets/front/image/project-5.jpg')}}" alt="">
                  <div class="portfolio-overlay"> <a class="popup-ajax stretched-link" href="#"></a>
                    <div class="portfolio-overlay-details">
                      <p class="text-primary text-8"><i class="fas fa-file-alt"></i></p>
            ...
            <div class="col-sm-6 col-lg-4 mockups" data-wow-delay="0.3s" style="position: absolute; left: 759.968px; top: 405.406px;">
              <div class="portfolio-box">
                <div class="portfolio-img"> <img class="img-fluid d-block" src="{{asset('assets/front/image/project-6.jpg')}}" alt="">
                  <div class="portfolio-overlay"> <a class="popup-img stretched-link" href="{{asset('assets/front/image/project-6.jpg')}}"></a>
                    <div class="portfolio-overlay-details">
                      <p class="text-primary text-8"><i class="fas fa-image"></i></p>
    ...
    <section>
      <div class="hero-wrap">
        ...
        <div class="hero-bg parallax" style="background-image:  url('{{ asset('assets/front/image/intro-bg-2.jpg') }}'); background-size: cover; background-repeat: no-repeat; background-attachment: fixed; background-position: center 2435.2px;"></div>
        <div class="hero-content section">
          <div class="container text-center py-5 wow fadeInUp" style="visibility: hidden; animation-name: none;">
            <h2 class="text-10 fw-600 text-white mb-5">Interested in working with me?</h2>
            <a href="#" class="btn btn-primary rounded-0 smooth-scroll wow rubberBand" data-wow-delay="1s" style="visibility: hidden; animation-delay: 1s; animation-name: none;">Hire Me!</a> </div>
        </div>
      </div>
    </section>
    <!-- Call to Action end --> 
    ...
    <section id="faq" class="section bg-light">
      <div class="container">
        <div class="row gy-5">
          ...
          <div class="col-lg-6 d-flex align-items-center justify-content-center order-0 order-lg-1 wow fadeIn" data-wow-delay="1s" style="visibility: hidden; animation-delay: 1s; animation-name: none;"> <img class="img-fluid" src="{{asset('assets/front/image/faq.png')}}" title="FAQ" alt="faq"> </div>
        </div>
      </div>
    </section>
    <!-- FAQ end --> 
    ...
    <section id="testimonial" class="section bg-secondary">
      <div class="container"> 
        <!-- Heading -->
        <p class=" text-center mb-2 wow fadeIn" style="visibility: hidden; animation-name: none;"><span class="bg-primary text-dark px-2">Client Speak</span></p>
        <h2 class="text-10 fw-600 text-white text-center mb-5 wow fadeIn" style="visibility: hidden; animation-name: none;">What Some of my Clients Say</h2>
        <!-- Heading end-->
        <div class="row">
          <div class="col-lg-9 mx-auto wow fadeInUp" style="visibility: hidden; animation-name: none;">
            ...
            <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-3404px, 0px, 0px); transition: 0.25s; width: 6818px; padding-left: 5px; padding-right: 5px;">
                <div class="owl-item cloned" style="width: 821px; margin-right: 30px;"><div class="item text-center px-5"> <span class="text-9 text-primary"><i class="fa fa-quote-start"></i></span>
                ...
                <img class="img-fluid d-inline-block w-auto rounded-circle shadow" src="{{asset('assets/front/image/client-sm-3.jpg')}}" alt="">
                 <strong class="d-block text-3 fw-500 text-white">Dennis Jacques</strong> <span class="text-light">Noon Inc</span> </div></div><div class="owl-item cloned" style="width: 821px; margin-right: 30px;"><div class="item text-center px-5"> <span class="text-9 text-primary"><i class="fa fa-quote-start"></i></span>
                ...
                <img class="img-fluid d-inline-block w-auto rounded-circle shadow" src="{{asset('assets/front/image/client-sm-4.jpg')}}" alt=""> <strong class="d-block text-3 fw-500 text-white">Chris Tom</strong> <span class="text-light">Company CEO from UK</span> </div></div><div class="owl-item" style="width: 821px; margin-right: 30px;"><div class="item text-center px-5"> <span class="text-9 text-primary"><i class="fa fa-quote-start"></i></span>
                ...
                <img class="img-fluid d-inline-block w-auto rounded-circle shadow" src="{{asset('assets/front/image/client-sm-1.jpg')}}" alt=""> <strong class="d-block text-3 fw-600 text-white">Jay Shah</strong> <span class="text-light">Founder at Icomatic Pvt Ltd</span> </div></div><div class="owl-item" style="width: 821px; margin-right: 30px;"><div class="item text-center px-5"> <span class="text-9 text-primary"><i class="fa fa-quote-start"></i></span>
                ...
                <img class="img-fluid d-inline-block w-auto rounded-circle shadow" src="{{asset('assets/front/image/client-sm-2.jpg')}}" alt=""> <strong class="d-block text-3 fw-500 text-white">Patrick Cary</strong> <span class="text-light">Freelancer from USA</span> </div></div><div class="owl-item active" style="width: 821px; margin-right: 30px;"><div class="item text-center px-5"> <span class="text-9 text-primary"><i class="fa fa-quote-start"></i></span>
                <p class="text-5 text-white">“Only trying it out since a few days. But up to now excellent. Seems to work flawlessly. priced simply dummy text of the printing and typesetting industry.”</p>
                <img class="img-fluid d-inline-block w-auto rounded-circle shadow" src="{{asset('assets/front/image/client-sm-3.jpg')}}" alt=""> <strong class="d-block text-3 fw-500 text-white">Dennis Jacques</strong> <span class="text-light">Noon Inc</span> </div></div><div class="owl-item" style="width: 821px; margin-right: 30px;"><div class="item text-center px-5"> <span class="text-9 text-primary"><i class="fa fa-quote-start"></i></span>
                <p class="text-5 text-white">“I have used them twice now. Good rates, very efficient service and priced simply dummy text of the printing and typesetting industry quidam interesset his et. simply dummy text of the printing and typesetting industry. Excellent.”</p>
                <img class="img-fluid d-inline-block w-auto rounded-circle shadow" src="{{asset('assets/front/image/client-sm-4.jpg')}}" alt=""> <strong class="d-block text-3 fw-500 text-white">Chris Tom</strong> <span class="text-light">Company CEO from UK</span> </div></div><div class="owl-item cloned" style="width: 821px; margin-right: 30px;"><div class="item text-center px-5"> <span class="text-9 text-primary"><i class="fa fa-quote-start"></i></span>
                <p class="text-5 text-white">Easy to use, reasonably priced simply dummy text of the printing and typesetting industry. Quidam lisque persius interesset his et, in quot quidam possim iriure. simply dummy text of the printing and typesetting industry.”</p>
                <img class="img-fluid d-inline-block w-auto rounded-circle shadow" src="{{asset('assets/front/image/client-sm-1.jpg')}}" alt=""> <strong class="d-block text-3 fw-600 text-white">Jay Shah</strong> <span class="text-light">Founder at Icomatic Pvt Ltd</span> </div></div><div class="owl-item cloned" style="width: 821px; margin-right: 30px;"><div class="item text-center px-5"> <span class="text-9 text-primary"><i class="fa fa-quote-start"></i></span>
                <p class="text-5 text-white">“I am happy Working with printing and typesetting industry. Quidam lisque persius interesset his et, in quot quidam persequeris essent possim iriure. simply dummy text of the printing and typesetting industry.”</p>
                <img class="img-fluid d-inline-block w-auto rounded-circle shadow" src="{{asset('assets/front/image/client-sm-2.jpg')}}" alt=""> <strong class="d-block text-3 fw-500 text-white">Patrick Cary</strong> <span class="text-light">Freelancer from USA</span> </div></div></div></div><div class="owl-nav"><button type="button" role="presentation" class="owl-prev"><i class="fa fa-chevron-left"></i></button>
                
            </div>
            

            <button role="button" class="owl-dot active">
                <span></span></button><button role="button" class="owl-dot"><span></span></button></div></div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="contact" class="section bg-primary">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 ms-auto mt-5 mt-lg-0 wow fadeInUp" data-wow-delay="0.3s" style="visibility: hidden; animation-delay: 0.3s; animation-name: none;">
            <h2 class="text-10 fw-600 text-center text-lg-start mb-5">Estimate your Project?</h2>
            <!-- Contact Form -->
            <form id="contact-form" class="form-border" action="https://harnishdesign.net/demo/html/callum/php/mail.php" method="post">
              <div class="row g-4">
                <div class="col-12">
